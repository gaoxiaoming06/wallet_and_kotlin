...
//            mDialogUtil.showDialog("检测器初始化失败");
    ...
    private class DecodeThread extends Thread {
                ...
                while ((imgData = mFrameDataQueue.take()) != null) {
                    ...
                    if (result != null) {
                        ...
                        if (result.isValid()) {
                            ...
                            mHasSuccess = true;
                            try {
                                //处理imgData 转换为bitmap byte[]
                                YuvImage image = new YuvImage(imgData, ImageFormat.NV21, imageWidth, imageHeight, null);
        ...
        private void handleSuccess(Bitmap imgData, IDCardQualityResult result) {
            ...
            //全景图
            intent.putExtra("idcardEnvImg", Util.bmp2byteArr(imgData));
            //裁切过的图
