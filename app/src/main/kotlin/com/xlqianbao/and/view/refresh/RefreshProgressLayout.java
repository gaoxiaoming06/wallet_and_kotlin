...
/**
 * desc: 修改RefreshProgressLayout的样式
 * Created by Liz on 2016/9/24.
 * github: https://github.com/lizwangying
 */

/**
 * The RefreshProgressLayout should be used whenever the user can refresh the
 * contents of a view via a vertical swipe gesture. The activity that
 * instantiates this view should add an OnRefreshListener to be notified
 * whenever the swipe to refresh gesture is completed. The RefreshProgressLayout
 ...
 * width and the height supplied in this layout. The RefreshProgressLayout does not
 * provide accessibility events; instead, a menu item must be provided to allow
 * refresh of the content wherever this gesture is used.
 * </p>
 */
public class RefreshProgressLayout extends ViewGroup implements NestedScrollingParent,
    ...
    /**
     * Simple constructor to use when creating a RefreshProgressLayout from code.
     *
     * @param context
     */
    ...
    /**
     * Constructor that is called when inflating RefreshProgressLayout from XML.
     *
     * @param context
     * @param attrs
     */
